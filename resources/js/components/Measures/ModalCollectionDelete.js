...
class ModalCollectionDelete extends React.Component {
    componentDidMount(){
        document.addEventListener("keydown", this.escFunction, false);
    }
    escFunction = e => {
        if(e.keyCode === 27) this.props.onTriggerCloseModal()
    }
    render(){
        let {collectionHash, onTriggerCloseModal, onClickDeleteCollection} = this.props;
        return (
